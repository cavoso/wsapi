...
class WhatsAppMessage {
  ...
  createContactoMessage(contacto, previousMessageId = null){
    this.type = 'contacts';
    this.content = contacto;
    return this.toJSON();
  }
  
  createLocationMessage(latitude, longitude, name, address, previousMessageId = null) {
    this.type = 'location';
    this.content = {
      latitude: latitude,
      longitude: longitude,
  ...
  createTemplateMessage(name, languageCode, components, previousMessageId = null) {
    this.type = 'template';
    this.content = {
      name: name,
      language: {
